...
if (.Platform$OS.type == "windows") { root.path = "C:/Users/psioda/Desktop/bayesDesignBasketHetero/BMA/RESULTS_MIXED"; }
if (.Platform$OS.type == "unix")    { root.path = "/proj/psiodalab/projects/bayesDesignBasketHetero/BMA/RESULTS_MIXED";                                 }
...
nSims        = 200000;                                            ## number of simulation studies to perform;
...
prior.stats[[2]] <- c(0.23,0.50);
prior.stats[[3]] <- c(0.10,0.40);
prior.stats[[4]] <- c(0.00,0.50);
...
for (k41 in c(0.00,0.50,0.25)) {
for (k42 in c(0.00,0.50,0.25)) {
