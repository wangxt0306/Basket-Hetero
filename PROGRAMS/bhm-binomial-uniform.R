...
if (.Platform$OS.type == "windows") { root.path = "C:/Users/psioda/Desktop/bayesDesignBasketHetero/BHM/RESULTS_BINOMIAL_UNIFORM"; }
if (.Platform$OS.type == "unix")    { root.path = "/proj/psiodalab/projects/bayesDesignBasketHetero/BHM/RESULTS_BINOMIAL_UNIFORM"; }                                 }
