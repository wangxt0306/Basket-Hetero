...
setwd(root.path);
source(".//source-bhm-unif-sd.rcpp");


if (.Platform$OS.type == "windows") { root.path = "C:/Users/psioda/Desktop/bayesDesignBasketHetero/BHM/RESULTS_MIXED_UNIFORM"; }
if (.Platform$OS.type == "unix")    { root.path = "/proj/psiodalab/projects/bayesDesignBasketHetero/BHM/RESULTS_MIXED_UNIFORM";                                 }
